...
<body>
    ...
    <div class="glass-card">
        <h4 class="mb-4 text-center"><i class="bi bi-plus-square-fill"></i> Tambah Produk</h4>

        <form method="post" enctype="multipart/form-data" action="<?= site_url('admin/produk/store') ?>">
            <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="jumlah_satuan_besar" id="jumlah_satuan_besar" class="form-control" required>
                </div>
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="harga_satuan_besar" id="harga_satuan_besar" class="form-control" required>
            </div>

            <div class="row">
                <div class="col-md-6 mb-3">
                    <label>Harga Eceran (Otomatis)</label>
                    <input type="number" id="harga_eceran" name="harga_eceran" class="form-control" readonly>
                </div>
                <div class="col-md-6 mb-3">
